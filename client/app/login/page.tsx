...
export default function LoginPage() {
  ...
  async function doGoogle() {
    ...
    try {
      ...
      // After successful Google login, redirect to chat
      // The chat page will handle the Firebase user session
      router.push("/chat");
    } catch (e: any) {
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-card p-8">
          ...
          >
            ...
            {isFirebaseEnabled ? 'Continue with Google' : 'Google Sign-in (Not Available)'}
          </button>

          {!isFirebaseEnabled && (
            <div className="mb-4 p-3 bg-yellow-900/50 border border-yellow-700 rounded-lg text-yellow-200 text-sm text-center">
              <strong>Note:</strong> Google sign-in requires Firebase configuration. Use email/password or demo login below.
            </div>
          )}
