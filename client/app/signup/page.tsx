...
import { signupWithEmail, loginAsDemo } from "@/lib/api";
...
export default function SignupPage() {
  ...
  async function doEmailSignup(e: React.FormEvent) {
    e.preventDefault();
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70 text-lg">
            Sign up to get unlimited access to GLAD GPT
          </p>
        </div>
        ...
        <div className="glass-card p-8">
          ...
          {/* Email Form */}
          <form onSubmit={doEmailSignup} className="space-y-5">
